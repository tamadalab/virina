...
//            return;
    ...
    public static void api(File file, Double valueOfTokens) {
        try {
            ...
            // 質問内容
            String question = "Please determine if the following source code was generated by AI. Answer Yes if you judge that it was written by AI, and No if you judge that it was not written by AI. Please make your judgment by focusing on the error handling. Also, indicate the confidence level of your judgment on a scale from 0% to 100%." ;
